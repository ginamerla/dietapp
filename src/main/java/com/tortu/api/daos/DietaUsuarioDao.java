...
public interface DietaUsuarioDao extends GenericDao<DietaUsuario, Integer> {
    ...
    public static final String FINDBYID =
            "select * from dieta_usuario inner join usuario on dieta_usuario.id_usuario = usuario.id_usuario where id_dieta_usuario = ?";
    public static final String SAVE =
            "insert into dieta_usuario (id_usuario, dia_semana) values (?, ?)";
